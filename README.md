...
4. An Excel workbook is written to the ignored `analysis-output/` directory. It contains metadata, issue-level analysis, category distribution and sub-category distribution sheets.
