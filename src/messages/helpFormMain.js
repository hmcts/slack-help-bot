    ...
    return [
		...
		},
		{
			...
			"element": {
                ...
                ...(helpRequest?.environment && { "initial_option": helpRequest.environment })
			},
			"label": {
				"type": "plain_text",
		...
		},
		{
			...
			"element": {
				...
				"options": [
                    ...
                    optionBlock('Security Operations or Secure design', 'security'),
                    optionBlock('SSCS'),
		...
		},
		{
			...
			"element": {
                ...
                ...(helpRequest?.checkedWithTeam && { "initial_option": helpRequest.checkedWithTeam })
			},
			"label": {
				"type": "plain_text",
